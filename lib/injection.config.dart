...
import 'package:survey/application/auth/auth_bloc.dart' as _i23;
...
import 'package:survey/application/survey/survey_form/survey_form_cubit.dart'
    as _i20;
import 'package:survey/application/survey/survey_results_watcher/survey_results_watcher_cubit.dart'
    as _i21;
...
import 'package:survey/infrastructure/core/app_injectable_module.dart' as _i24;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i21.SurveyResultWatcherCubit>(
        () => _i21.SurveyResultWatcherCubit(gh<_i10.ISurveyRepository>()));
    gh.factory<_i22.SurveyWatcherCubit>(
        () => _i22.SurveyWatcherCubit(gh<_i10.ISurveyRepository>()));
