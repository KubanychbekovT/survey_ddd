...
import 'package:survey/application/auth/auth_bloc.dart' as _i21;
...
import 'package:survey/infrastructure/core/app_injectable_module.dart' as _i22;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i19.SurveyFormCubit>(
        () => _i19.SurveyFormCubit(gh<_i10.ISurveyRepository>()));
    gh.factory<_i20.SurveyWatcherCubit>(
        () => _i20.SurveyWatcherCubit(gh<_i10.ISurveyRepository>()));
    gh.factory<_i21.AuthBloc>(() => _i21.AuthBloc(gh<_i8.IAuthFacade>()));
    return this;
  }
}

class _$AppInjectableProdModule extends _i22.AppInjectableProdModule {}
