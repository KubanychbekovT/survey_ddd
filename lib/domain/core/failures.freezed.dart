...
class __$$ListTooShortCopyWithImpl<T, $Res>
    extends _$ValueFailureCopyWithImpl<T, $Res, _$ListTooShort<T>>
...
class _$ListTooShort<T> implements ListTooShort<T> {
  _$ListTooShort({required this.failedValue, required this.min});
...
abstract class ListTooShort<T> implements ValueFailure<T> {
  factory ListTooShort({required final T failedValue, required final int min}) =
      _$ListTooShort<T>;
