...
abstract class SurveyFormState with _$SurveyFormState{
  factory SurveyFormState({required Survey survey,required AutovalidateMode showErrorMessages,required bool isProcessing,required Option<Either<FirebaseFirestoreFailure,Unit>> surveyFailureSuccessOption})= _SurveyFormState;
